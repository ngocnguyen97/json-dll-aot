...
namespace Newtonsoft.Json
{
  ...
  public static class JsonConvert
  {
    ...
    private static readonly JsonSerializerSettings InitialSerializerSettings = new JsonSerializerSettings();
    ...
    /// <summary>Serializes the XML node to a JSON string.</summary>
    ...
    /// <summary>Deserializes the XmlNode from a JSON string.</summary>
