...
namespace Newtonsoft.Json.Serialization
{
  ...
  internal class JsonSerializerInternalWriter : JsonSerializerInternalBase
  {
      ...
      JsonProperty containerProperty)
    {
      ...
      if ((nullable.HasValue ? (nullable.GetValueOrDefault() ? 1 : 0) : (this.HasFlag(this.Serializer._preserveReferencesHandling, PreserveReferencesHandling.Objects) ? 1 : 0)) != 0 && (member == null || member.Writable))
      ...
      JsonProperty containerProperty)
    {
      ...
      foreach (object obj2 in values)
      {
        ...
        {
          if (this.IsErrorHandled(obj1, (JsonContract) contract, (object) num, (IJsonLineInfo) null, writer.ContainerPath, ex))
            this.HandleError(writer, top);
          else
            throw;
        }
      ...
      JsonProperty containerProperty)
    {
      ...
      bool flag1 = (nullable.HasValue ? nullable.GetValueOrDefault() : this.HasFlag(this.Serializer._preserveReferencesHandling, PreserveReferencesHandling.Arrays)) && (member == null || member.Writable);
