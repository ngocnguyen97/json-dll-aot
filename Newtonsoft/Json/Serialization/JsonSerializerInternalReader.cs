  ...
  internal class JsonSerializerInternalReader : JsonSerializerInternalBase
  {
    ...
    public void Populate(JsonReader reader, object target)
    {
      ...
      if (reader.TokenType == JsonToken.StartArray)
      {
        if (jsonContract.ContractType != JsonContractType.Array)
          throw JsonSerializationException.Create(reader, "Cannot populate JSON array onto type '{0}'.".FormatWith((IFormatProvider) CultureInfo.InvariantCulture, (object) type));
        JsonArrayContract contract = (JsonArrayContract) jsonContract;
        this.PopulateList(contract.ShouldCreateWrapper ? (IList) contract.CreateWrapper(target) : (IList) target, reader, contract, (JsonProperty) null, (string) null);
      }
      else
      {
        ...
        if (jsonContract.ContractType == JsonContractType.Dictionary)
        {
          ...
          this.PopulateDictionary(contract.ShouldCreateWrapper ? (IDictionary) contract.CreateWrapper(target) : (IDictionary) target, reader, contract, (JsonProperty) null, id);
        }
        else
        {
      ...
      switch (contract.ContractType)
      {
        ...
        case JsonContractType.Primitive:
          ...
          if (this.Serializer.MetadataPropertyHandling != MetadataPropertyHandling.Ignore && reader.TokenType == JsonToken.PropertyName && string.Equals(reader.Value.ToString(), "$value", StringComparison.Ordinal))
          {
            ...
            object valueInternal = this.CreateValueInternal(reader, objectType1, (JsonContract) primitiveContract, member, (JsonContainerContract) null, (JsonProperty) null, existingValue);
            reader.ReadAndAssert();
        ...
        case JsonContractType.Dictionary:
          ...
          if (existingValue == null)
          {
            ...
            obj = this.PopulateDictionary(contract1.ShouldCreateWrapper ? (IDictionary) contract1.CreateWrapper(existingValue) : (IDictionary) existingValue, reader, contract1, member, id);
          return obj;
        case JsonContractType.Serializable:
      ...
      if (reader.TokenType == JsonToken.StartObject)
      {
        ...
        if (jtoken1 != null)
        {
          if (jtoken1.Type != JTokenType.String && jtoken1.Type != JTokenType.Null)
            throw JsonSerializationException.Create((IJsonLineInfo) jtoken1, jtoken1.Path, "JSON reference {0} property must have a string or null value.".FormatWith((IFormatProvider) CultureInfo.InvariantCulture, (object) "$ref"), (Exception) null);
          ...
          {
            if (jtoken2 != null)
              throw JsonSerializationException.Create((IJsonLineInfo) jtoken2, jtoken2.Path, "Additional content found in JSON reference object. A JSON reference object should only have a {0} property.".FormatWith((IFormatProvider) CultureInfo.InvariantCulture, (object) "$ref"), (Exception) null);
      ...
      string qualifiedTypeName)
    {
      ...
      if (objectType != null && !objectType.IsAssignableFrom(type))
        throw JsonSerializationException.Create(reader, "Type specified in JSON '{0}' is not compatible with '{1}'.".FormatWith((IFormatProvider) CultureInfo.InvariantCulture, (object) type.AssemblyQualifiedName, (object) objectType.AssemblyQualifiedName));
      objectType = type;
      ...
      string id)
    {
      ...
      if (existingValue == null)
      {
        ...
        {
          if (contract1.IsMultidimensionalArray)
            list = (IList) CollectionUtils.ToMultidimensionalArray(list, contract1.CollectionItemType, contract.CreatedType.GetArrayRank());
      ...
      else
      {
        ...
        obj = this.PopulateList(contract1.ShouldCreateWrapper ? (IList) contract1.CreateWrapper(existingValue) : (IList) existingValue, reader, contract1, member, id);
      }
      return obj;
    }
            ...
            if (!this.CheckPropertyName(reader, keyValue.ToString()))
            {
              try
              {
                try
                {
                  switch (primitiveTypeCode)
                  {
                    ...
                    case PrimitiveTypeCode.DateTimeNullable:
                      DateTime dt1;
                      keyValue = !DateTimeUtils.TryParseDateTime(keyValue.ToString(), reader.DateTimeZoneHandling, reader.DateFormatString, reader.Culture, out dt1) ? this.EnsureType(reader, keyValue, CultureInfo.InvariantCulture, contract.KeyContract, contract.DictionaryKeyType) : (object) dt1;
                      break;
                    case PrimitiveTypeCode.DateTimeOffset:
                    case PrimitiveTypeCode.DateTimeOffsetNullable:
                      DateTimeOffset dt2;
                      keyValue = !DateTimeUtils.TryParseDateTimeOffset(keyValue.ToString(), reader.DateFormatString, reader.Culture, out dt2) ? this.EnsureType(reader, keyValue, CultureInfo.InvariantCulture, contract.KeyContract, contract.DictionaryKeyType) : (object) dt2;
                      break;
                    default:
                ...
                if (!this.ReadForType(reader, contract.ItemContract, converter != null))
                  throw JsonSerializationException.Create(reader, "Unexpected end when deserializing object.");
                object obj = converter == null || !converter.CanRead ? this.CreateValueInternal(reader, contract.DictionaryValueType, contract.ItemContract, (JsonProperty) null, (JsonContainerContract) contract, containerProperty, (object) null) : this.DeserializeConvertable(converter, reader, contract.DictionaryValueType, (object) null);
                dictionary[keyValue] = obj;
                goto case JsonToken.Comment;
              }
              catch (Exception ex)
              {
                if (this.IsErrorHandled(currentObject, (JsonContract) contract, keyValue, reader as IJsonLineInfo, reader.Path, ex))
                {
      ...
      string id)
    {
      ...
      SerializationInfo serializationInfo = new SerializationInfo(contract.UnderlyingType, (IFormatterConverter) new JsonFormatterConverter(this, contract, member));
      bool flag = false;
      do
      {
        switch (reader.TokenType)
      ...
      string id)
    {
      ...
      foreach (JsonSerializerInternalReader.CreatorPropertyContext creatorPropertyContext in source)
      {
        if (flag && creatorPropertyContext.Property != null && !creatorPropertyContext.Presence.HasValue)
        {
          ...
          JsonSerializerInternalReader.PropertyPresence propertyPresence = obj != null ? (!(obj is string) ? JsonSerializerInternalReader.PropertyPresence.Value : (JsonSerializerInternalReader.CoerceEmptyStringToNull(creatorPropertyContext.Property.PropertyType, creatorPropertyContext.Property.PropertyContract, (string) obj) ? JsonSerializerInternalReader.PropertyPresence.Null : JsonSerializerInternalReader.PropertyPresence.Value)) : JsonSerializerInternalReader.PropertyPresence.Null;
          ...
          if ((presence.GetValueOrDefault() == propertyPresence ? (presence.HasValue ? 1 : 0) : 0) == 0)
          {
            ...
            else if (!property.Writable && obj2 != null)
            {
              ...
              if (jsonContract.ContractType == JsonContractType.Array)
              {
                ...
                object list = property.ValueProvider.GetValue(obj1);
                if (list != null)
                {
              ...
              else if (jsonContract.ContractType == JsonContractType.Dictionary)
              {
                ...
                if (dictionary1 != null)
                {
                  ...
                  IDictionaryEnumerator enumerator = (dictionaryContract.ShouldCreateWrapper ? (IDictionary) dictionaryContract.CreateWrapper(obj2) : (IDictionary) obj2).GetEnumerator();
                  try
                  {
      ...
      if (flag)
      {
        foreach (JsonSerializerInternalReader.CreatorPropertyContext creatorPropertyContext in source)
        {
          if (creatorPropertyContext.Property != null)
            this.EndProcessProperty(obj1, reader, contract, reader.Depth, creatorPropertyContext.Property, creatorPropertyContext.Presence.GetValueOrDefault(), !creatorPropertyContext.Used);
        }
      }
